...
- needs the counter (recognised product, label-dependent rule) → 404 `{ accepted: null, verdict: "Ask at the counter", error: "We know this one but the refund depends on the label. Show it at the counter.", upc, name, hint: "Look for the words Return for Refund on the label." }`
