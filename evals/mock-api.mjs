...
http.createServer((req, res) => {
  ...
  send(res, 200, { upc: r.upc, name: r.name, brand: r.brand, size_ml: r.size_ml, class: r.class, refund_cents: r.refund_cents, material: r.material, why: '(mock)', source: r.source, note: NOTE });
