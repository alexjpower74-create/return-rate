...
const cases = [
  ...
  ['tetra, wine', { drink: 'wine', material: 'tetra', size_ml: 1000 }, 'regular', 5],
  ['gable, wine', { drink: 'wine', material: 'gable', size_ml: 1000 }, 'regular', 5],
  ...
  ['tetra wine', { drink: 'wine', material: 'tetra', size_ml: 500 }, 'regular', 5],
  ...
  ['refillable Quidi Vidi bottle', { drink: 'beer', material: 'glass', size_ml: 341, refillable: true }, 'brewer', 5],
