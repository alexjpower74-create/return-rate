...
(function () {
  ...
  var UNKNOWN_TEXT = "We don't know this one yet. Show it at the counter and we'll add it.";
    ...
    return fetch(base + '/item/' + upc, { signal: ctrl ? ctrl.signal : undefined })
      .then(function (res) {
        return res.json().catch(function () { return {}; }).then(function (body) {
          ...
          if (res.status === 404) return { status: 'unknown', message: body.error || UNKNOWN_TEXT };
